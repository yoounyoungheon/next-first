  ...
  return (
    <div className="w-full md:col-span-4">
      ...
      <div className="sm:grid-cols-13 mt-0 grid grid-cols-12 items-end gap-2 rounded-md bg-white p-4 md:gap-4">
        ...
        {revenue.map((info)=>(
          <div key={info.month} className="flex flex-col items-center gap-2">
            <div className="w-full rounded-md bg-blue-300" style={{height: `${(chartHeight/topLabel)*info.revenue}px`}} />
